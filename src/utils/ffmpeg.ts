...
export async function createFFmpeg() {
    const ffmpeg = originalCreateFFmpeg({
        log: true,
        getCreateFFmpegCore,
        corePath: path.join(process.cwd(), 'node_modules/@ffmpeg/core/dist/', 'ffmpeg-core.js'),
        workerPath: path.join(process.cwd(), 'node_modules/@ffmpeg/core/dist/', 'ffmpeg-core.worker.js'),
        wasmPath: path.join(process.cwd(), 'node_modules/@ffmpeg/core/dist/', 'ffmpeg-core.wasm'),
